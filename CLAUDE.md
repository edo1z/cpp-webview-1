...
#### バイナリデータ処理
- [ ] **06. 画像ビューア** - Base64エンコード/デコード、バイナリデータの送受信
- [ ] **07. 音声レコーダー** - AudioBufferとC++の連携、リアルタイム音声処理
...
#### イベントシステム
- [ ] **12. カスタムイベントデモ** - C++からのイベント発火、動的リスナー登録
- [ ] **13. ドラッグ&ドロップ** - ファイルドロップイベントの処理

#### 高度な最適化
- [ ] **14. 大容量データビューア** - メモリ効率的な転送、仮想スクロール
- [ ] **15. リアルタイムグラフ** - 高頻度データ更新の最適化

#### プラグインとセキュリティ
- [ ] **16. プラグインローダー** - 動的ライブラリロード、関数の動的登録
- [ ] **17. サンドボックスデモ** - セキュアな実行環境、権限管理

#### デバッグとツール連携
- [ ] **18. デバッガー統合** - C++ログのJSコンソール出力、スタックトレース
- [ ] **19. パフォーマンスプロファイラー** - 実行時間計測、ボトルネック分析

#### 総合プロジェクト
- [ ] **20. ミニIDE** - 上記技術を統合した開発環境
